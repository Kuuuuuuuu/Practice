...
use pocketmine\item\Bow as ItemBow;
...
class Bow extends ItemBow
{
    ...
    public function onReleaseUsing(Player $player): ItemUseResult
    {
        ...
        $p = $diff / 20;
        $baseForce = min((($p ** 2) + $p * 2) / 3, 1) ? $player->getWorld() === Server::getInstance()->getWorldManager()->getWorldByName(Loader::getInstance()->getArenaFactory()->getOITCArena()) : 3;
