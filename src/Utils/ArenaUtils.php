        ...
        if ($arena === Loader::$arenafac->getOITCArena()) {
            if ($dplayer->getWorld() === Server::getInstance()->getWorldManager()->getWorldByName(Loader::$arenafac->getOITCArena())) {
                if ($dplayer instanceof HorizonPlayer) {
                    ...
                    try {
                        $dplayer->getInventory()->setItem(0, ItemFactory::getInstance()->get($dplayer->getKit()["0"]["oitc"]["0"]["item"], 0, $dplayer->getKit()["0"]["oitc"]["0"]["count"])->addEnchantment(new EnchantmentInstance(VanillaEnchantments::UNBREAKING(), 10))->addEnchantment(new EnchantmentInstance(VanillaEnchantments::POWER(), 200)));
                        $dplayer->getInventory()->setItem(1, ItemFactory::getInstance()->get($dplayer->getKit()["0"]["oitc"]["1"]["item"], 0, $dplayer->getKit()["0"]["oitc"]["1"]["count"])->addEnchantment(new EnchantmentInstance(VanillaEnchantments::UNBREAKING(), 10))->addEnchantment(new EnchantmentInstance(VanillaEnchantments::POWER(), 200)));
                        $dplayer->getInventory()->setItem(2, ItemFactory::getInstance()->get($dplayer->getKit()["0"]["oitc"]["2"]["item"], 0, $dplayer->getKit()["0"]["oitc"]["2"]["count"])->addEnchantment(new EnchantmentInstance(VanillaEnchantments::UNBREAKING(), 10))->addEnchantment(new EnchantmentInstance(VanillaEnchantments::POWER(), 200)));
                        $dplayer->getInventory()->setItem(3, ItemFactory::getInstance()->get($dplayer->getKit()["0"]["oitc"]["3"]["item"], 0, $dplayer->getKit()["0"]["oitc"]["3"]["count"])->addEnchantment(new EnchantmentInstance(VanillaEnchantments::UNBREAKING(), 10))->addEnchantment(new EnchantmentInstance(VanillaEnchantments::POWER(), 200)));
                        $dplayer->getInventory()->setItem(4, ItemFactory::getInstance()->get($dplayer->getKit()["0"]["oitc"]["4"]["item"], 0, $dplayer->getKit()["0"]["oitc"]["4"]["count"])->addEnchantment(new EnchantmentInstance(VanillaEnchantments::UNBREAKING(), 10))->addEnchantment(new EnchantmentInstance(VanillaEnchantments::POWER(), 200)));
                        $dplayer->getInventory()->setItem(5, ItemFactory::getInstance()->get($dplayer->getKit()["0"]["oitc"]["5"]["item"], 0, $dplayer->getKit()["0"]["oitc"]["5"]["count"])->addEnchantment(new EnchantmentInstance(VanillaEnchantments::UNBREAKING(), 10))->addEnchantment(new EnchantmentInstance(VanillaEnchantments::POWER(), 200)));
                        $dplayer->getInventory()->setItem(6, ItemFactory::getInstance()->get($dplayer->getKit()["0"]["oitc"]["6"]["item"], 0, $dplayer->getKit()["0"]["oitc"]["6"]["count"])->addEnchantment(new EnchantmentInstance(VanillaEnchantments::UNBREAKING(), 10))->addEnchantment(new EnchantmentInstance(VanillaEnchantments::POWER(), 200)));
                        $dplayer->getInventory()->setItem(7, ItemFactory::getInstance()->get($dplayer->getKit()["0"]["oitc"]["7"]["item"], 0, $dplayer->getKit()["0"]["oitc"]["7"]["count"])->addEnchantment(new EnchantmentInstance(VanillaEnchantments::UNBREAKING(), 10))->addEnchantment(new EnchantmentInstance(VanillaEnchantments::POWER(), 200)));
                        $dplayer->getInventory()->setItem(8, ItemFactory::getInstance()->get($dplayer->getKit()["0"]["oitc"]["8"]["item"], 0, $dplayer->getKit()["0"]["oitc"]["8"]["count"])->addEnchantment(new EnchantmentInstance(VanillaEnchantments::UNBREAKING(), 10))->addEnchantment(new EnchantmentInstance(VanillaEnchantments::POWER(), 200)));
                    } catch (Exception) {
                        ...
                        $dplayer->getInventory()->setItem(2, ItemFactory::getInstance()->get(ItemIds::ARROW, 0, 1));
                    }
                }
            }
            ...
            if ($dplayer->getWorld() === Server::getInstance()->getWorldManager()->getWorldByName(Loader::$arenafac->getBuildArena())) {
                ...
                if ($dplayer instanceof HorizonPlayer) {
                    try {
                        $dplayer->getInventory()->setItem(0, ItemFactory::getInstance()->get($dplayer->getKit()["0"]["build"]["0"]["item"], 0, $dplayer->getKit()["0"]["build"]["0"]["count"])->addEnchantment(new EnchantmentInstance(VanillaEnchantments::UNBREAKING(), 10)));
                        $dplayer->getInventory()->setItem(1, ItemFactory::getInstance()->get($dplayer->getKit()["0"]["build"]["1"]["item"], 0, $dplayer->getKit()["0"]["build"]["1"]["count"])->addEnchantment(new EnchantmentInstance(VanillaEnchantments::UNBREAKING(), 10)));
                        $dplayer->getInventory()->setItem(2, ItemFactory::getInstance()->get($dplayer->getKit()["0"]["build"]["2"]["item"], 0, $dplayer->getKit()["0"]["build"]["2"]["count"])->addEnchantment(new EnchantmentInstance(VanillaEnchantments::UNBREAKING(), 10)));
                        $dplayer->getInventory()->setItem(3, ItemFactory::getInstance()->get($dplayer->getKit()["0"]["build"]["3"]["item"], 0, $dplayer->getKit()["0"]["build"]["3"]["count"])->addEnchantment(new EnchantmentInstance(VanillaEnchantments::UNBREAKING(), 10)));
                        $dplayer->getInventory()->setItem(4, ItemFactory::getInstance()->get($dplayer->getKit()["0"]["build"]["4"]["item"], 0, $dplayer->getKit()["0"]["build"]["4"]["count"])->addEnchantment(new EnchantmentInstance(VanillaEnchantments::UNBREAKING(), 10)));
                        $dplayer->getInventory()->setItem(5, ItemFactory::getInstance()->get($dplayer->getKit()["0"]["build"]["5"]["item"], 0, $dplayer->getKit()["0"]["build"]["5"]["count"])->addEnchantment(new EnchantmentInstance(VanillaEnchantments::UNBREAKING(), 10)));
                        $dplayer->getInventory()->setItem(6, ItemFactory::getInstance()->get($dplayer->getKit()["0"]["build"]["6"]["item"], 0, $dplayer->getKit()["0"]["build"]["6"]["count"])->addEnchantment(new EnchantmentInstance(VanillaEnchantments::UNBREAKING(), 10)));
                        $dplayer->getInventory()->setItem(7, ItemFactory::getInstance()->get($dplayer->getKit()["0"]["build"]["7"]["item"], 0, $dplayer->getKit()["0"]["build"]["7"]["count"])->addEnchantment(new EnchantmentInstance(VanillaEnchantments::UNBREAKING(), 10)));
                        $dplayer->getInventory()->setItem(8, ItemFactory::getInstance()->get($dplayer->getKit()["0"]["build"]["8"]["item"], 0, $dplayer->getKit()["0"]["build"]["8"]["count"])->addEnchantment(new EnchantmentInstance(VanillaEnchantments::UNBREAKING(), 10)));
                    } catch (Exception) {
